    ...
    return (
        <Panel id={id}>
            ...
            <div id='allfriends-start-screen'>
                ...
                <div className="paragraph">5. Если у данного пользователя достаточно много друзей, из-за ограничений API ВКонтакте,
                получение данных займёт существенное время. Во время работы приложения будет выводиться часть промежуточных результатов, 
                ...
                никакой слежки ни за Вами ни за Вашими друзьями не ведётся. Для запуска требуются только права на просмотр списка Ваших друзей.</div>
            </div>
