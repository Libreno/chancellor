    ...
    return (
        <Panel id={id}>
            ...
            <div id='allfriends-start-screen'>
                <div className="paragraph">Приложение выводит список групп, в которых состоят Ваши друзья.</div>
                <div className="paragraph">Можно анализировать профиль любого пользователя, чьи данные Вам доступны.</div>
                <div className="paragraph">Список будет отсортирован в порядке убывания числа друзей в группах.</div>
                <div className="paragraph">
                    Каждая строка имеет вид:</div>
                    <div>
                ...
                <div className="paragraph">Часто друзей бывает сотни и тысячи, поэтому получение данных занимает 
                ...
                <div className="paragraph">При большом количестве друзей (больше 1000) увеличение отображаемых промежуточных результатов 
                может заметно отразиться на общем времени получения данных (~ +10% к времени работы).</div>
                <div className="paragraph">Никакие персональные данные с Вашего устройства приложением никуда не отправляются.</div>
            </div>
